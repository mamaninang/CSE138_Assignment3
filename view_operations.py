...
def view_operations():
    ...
    if request.method == 'GET':
        ...
        if address_to_be_added in view_list:
            ...
            sending_broadcast_message(view_list,socket_address, address_to_be_added, replica_view,"put")
            return {"message":"Replica added successfully to the view"}, 201
        ...
        if address_to_delete not in view_list:
            ...
            sending_broadcast_message(view_list,socket_address, address_to_delete, replica_view,"delete")
            return {"message":"Replica deleted successfully from the view"}, 200
...
def sending_broadcast_message(view_list,socket_address, address_to_delete, replica_view, type_request):
    for ip in view_list:
